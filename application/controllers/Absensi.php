...
class Absensi extends MY_controller
{
	...
	public function detail_data($id)
	{
		...
		$karyawan_id = $this->ma->get($id)->row()->karyawan_id;
		if ($karyawan_id != $this->session->userdata('karyawan_id')) {
			$d = [
				['nama' => 'Absensi', 'link' => site_url('absensi/absensiAll'), 'active' => ''],
				['nama' => 'Detail Absensi', 'link' => '', 'active' => 'active']
			];
		} else {
			$d = [
				['nama' => 'Absensi', 'link' => site_url('absensi'), 'active' => ''],
				['nama' => 'Detail Absensi', 'link' => '', 'active' => 'active']
			];
		}
		$d = [
			'title' => 'Detail Data Absen',
			'linkView' => 'page/absensi/detail_data',
			'fileScript' => 'absensi/detail_data.js',
			'bread' => [
					'nama' => 'Detail Data Absen',
					'data' => $d
				],
			'data' => $data,
		];
