        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-6 col">Hutang Internal</div>
                        <div class="col-md-6 col text-right">
                            <a href="#" data-toggle="modal" data-target="#addModal" class="btn btn-danger">Add New</a>
                        </div>
                    </div>
                </div>
                ...
                <form action="">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-5 col"><label for="ID">ID</label></div>
                                    <div class="col-md-7 col"><input name="id" type="text" class="form-control" disabled></div>
                                </div>
                                <br>
                                <div class="row">
                                    <div class="col-md-5 col"><label for="ID">Name</label></div>
                                    <div class="col-md-7 col"><input name="name" type="text" class="form-control"></div>
                                </div>
                                <br>
                                <div class="row">
                                    <div class="col-md-5 col"><label for="ID">Description</label></div>
                                    <div class="col-md-7 col"><textarea name="desc" class="form-control"></textarea></div>
                                </div>
                                <br>
                                <div class="row">
                                    <div class="col-md-5 col"><label for="ID">No.Invoice</label></div>
                                    <div class="col-md-7 col"><input name="no_invoice" type="text" class="form-control"></div>
                                </div>
                                <br>
                                <div class="row">
                                    <div class="col-md-5 col"><label for="ID">Invoice Date</label></div>
                                    <div class="col-md-7 col"><input name="invoice_date" type="date" class="form-control"></div>
                                </div>
                                <br>
                                <div class="row">
                                    <div class="col-md-5 col"><label for="ID">Due Date</label></div>
                                    <div class="col-md-7 col"><input type="date" name="due_date" class="form-control"></div>
                                </div>
                                <br>
                                <div class="row">
                                    <div class="col-md-5 col"><label for="ID">Invoice</label></div>
                                    <div class="col-md-7 col"><input type="file" name="invoice" class="form-control"></div>
                                </div>
                                <br>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7 col">
                                        <div class="form-check form-check-inline">
                                            <input name="ppn" id="my-input" class="form-check-input" type="checkbox" name="" value="true">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7 col"><input name="bukti" type="file" class="form-control"></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-4 offset-md-1 col"><label for="">ID</label></div>
                                <div class="col-md-6 col">HTG001</div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-4 offset-md-1 col"><label for="">Name</label></div>
                                <div class="col-md-6 col">Gaguk Whardoyo</div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-4 offset-md-1 col"><label for="">Description</label></div>
                                <div class="col-md-6 col">Installasi N3N</div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-4 offset-md-1 col"><label for="">No.Invoice</label></div>
                                <div class="col-md-6 col">S20/01-007</div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-4 offset-md-1 col"><label for="">Invoice Date</label></div>
                                <div class="col-md-6 col">15 Januari 2020</div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-4 offset-md-1 col"><label for="">Due Date</label></div>
                                <div class="col-md-6 col">27 Januari 2020</div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-4 offset-md-1 col"><label for="">Invoice</label></div>
                                <div class="col-md-6 col"><a href="" class="btn btn-outline-danger btn-sm" style="width: 100%;">View</a></div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-4 offset-md-1 col"><label for="">Status</label></div>
                    ...
                    <br>
                    <div class="row">
                        <div class="col-md-12"><h5 style="color: tomato;">Count</h5></div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-4 offset-md-1 col"><label for="">No. Faktur Pajak</label></div>
                                <div class="col-md-6 col">-</div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-4 offset-md-1 col"><label for="">FP Date</label></div>
                                <div class="col-md-6 col">-</div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-4 offset-md-1 col"><label for="">Nilai Pokok</label></div>
                                <div class="col-md-6 col">1.050.000</div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-4 offset-md-1 col"><label for="">PPN 10%</label></div>
                                <div class="col-md-6 col">-</div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-4 offset-md-1 col"><label for="">PPH</label></div>
                                <div class="col-md-6 col">PPH 2.5% (Pasal 21)</div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-4 offset-md-1 col"><label for="">Nominal Payment</label></div>
                                <div class="col-md-6 col">Nilai Pokok / PPH</div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-4 offset-md-1 col"><label for="">Pay Date</label></div>
                                <div class="col-md-6 col">22 Jan 2020</div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-4 offset-md-1 col"><label for="">Bukti Pembayaran</label></div>
                                <div class="col-md-6 col"><a href="" class="btn btn-outline-danger btn-sm" style="width: 100%;">View</a></div>
                            </div>
                            <br>
                        </div>
