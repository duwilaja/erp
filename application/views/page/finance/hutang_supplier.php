        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-6 col">Hutang Supplier</div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">New Hutang Supplier</h5>
                ...
                <form action="">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-5 col"><label for="ID">ID Supplier</label></div>
                                    <div class="col-md-7 col"><input name="id" type="text" class="form-control" disabled></div>
                                </div>
                                <br>
                                <div class="row">
                                    <div class="col-md-5 col"><label for="ID">Supplier</label></div>
                                    <div class="col-md-7 col"><input name="supplier" type="text" class="form-control" disabled></div>
                                </div>
                                <br>
                                <div class="row">
                ...
                <div class="container">     
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <br>
                            <div class="row">
                                <div class="col-md-4 offset-md-1 col"><label for="">ID Supplier</label></div>
                                <div class="col-md-6 col">HTG001</div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-4 offset-md-1 col"><label for="">Supplier</label></div>
                                <div class="col-md-6 col">Gaguk Whardoyo</div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-4 offset-md-1 col"><label for="">ID Project</label></div>
                                <div class="col-md-6 col">M001</div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-4 offset-md-1 col"><label for="">Service</label></div>
                                <div class="col-md-6 col">Pengadaan N3N</div>
                            </div>
                            <br>
                            <div class="row">
