...
<!-- Menu Level 3 / HCM--> 
<?php if ($this->session->userdata('level') == '24') { ?>
    <div class="row">
        <div class="col-md-3 col-6">
            <div class="mycard rounded">
                <div class="card-body text-center">
                    <br>
                    <h4 style="color: #706c61"><i class="fas fa-thumbtack"></i> <strong>5</strong></h4>
        ...
        <div class="col-md-12 col-12">
            <div class="mycard rounded">
                <div class="card-body text-center">
                    <br>
                    <h4 style="color: tomato;"><i class="fas fa-dollar-sign"></i> <strong>100.000.000</strong></h4>
                    <p class="pt">Total Revenue</p>
        ...
        <div class="col-md-12">
            <div class="mycard rounded">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <p class="pt">Sales Target <small>(Based on the number of PO)</small></p>
                        </div>
                    </div>
                    ...
                    <div class="row bott">
                        <div class="col-md-6 text-center">
                            <h4 style="color: tomato;"><strong>150.000.000.000</strong></h4>
                            <p class="pt">Sales Target</p>
                        </div>

                        <div class="col-md-6 text-center" style="border-left: #f2f2f2 1px solid;">
                            <h4 style="color: #5f6caf;"><strong>50.000.000.000</strong></h4>
