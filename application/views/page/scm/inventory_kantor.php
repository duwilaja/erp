    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <h3 class="card-title" style="position: relative;top: 5px;">Inventory Kantor <span id="txtLE"></span></h3>
                    <div class="azsa" style="float: right;">
                        <a href="#" data-toggle="modal" data-target="#modal_form_inventory" class="btn btn-success btn-sm">Tambah Barang</a>
                </div>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
